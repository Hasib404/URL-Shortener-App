...
SQLALCHEMY_DATABASE_URL = "postgresql://username:password@localhost:5436/nudges"
POOL_SIZE = 20
POOL_RECYCLE = 3600
POOL_TIMEOUT = 15
MAX_OVERFLOW = 2
...
class Database():
    ...
    def get_db_connection(self):
        if self.connection_is_active == False:
            ...
            try:
                self.engine = create_engine(SQLALCHEMY_DATABASE_URL, pool_size=POOL_SIZE, pool_recycle=POOL_RECYCLE,
